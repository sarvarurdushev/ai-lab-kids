...
export const AI_OR_NOT_SETS: ActivitySegment[] = [
  {
    ...
    config: {
      ...
      items: [
        ...
        { scenario: "A motion-sensor light", emoji: "🚶💡", isAI: false, explanation: "No — one fixed rule: motion means on." },
        { scenario: "Reads your messy handwriting", emoji: "✍️👀", isAI: true, explanation: "Yes! It learned all kinds of letters." },
        { scenario: "A doorbell", emoji: "🔔", isAI: false, explanation: "No — press, ring, done." },
        {
          scenario: "Suggests a video to watch next",
          emoji: "📺🤔",
          isAI: true,
          explanation: "Yes! It learned what you watch.",
          minTrack: "explorers",
        },
      ],
    },
  },
  {
    ...
    config: {
      ...
      items: [
        ...
        { scenario: "A ruler", emoji: "📏", isAI: false, explanation: "No — just measures." },
        { scenario: "A pencil sharpener", emoji: "✏️🌀", isAI: false, explanation: "No — same spin every time." },
        {
          scenario: "Grades your quiz and explains why",
          emoji: "📝✅",
          isAI: true,
          explanation: "Yes! It checks and learns patterns.",
          minTrack: "explorers",
        },
        { scenario: "Reads a story out loud", emoji: "📖🔊", isAI: true, explanation: "Yes! It learned how words sound." },
      ],
    },
  },
  {
    ...
    config: {
      ...
      items: [
        ...
        { scenario: "A stop sign", emoji: "🛑", isAI: false, explanation: "No — just a sign." },
        { scenario: "Opens the right elevator floor", emoji: "🛗", isAI: false, explanation: "No — you pressed the button." },
        {
          scenario: "Unlocks a phone with your face",
          emoji: "🤳🔓",
          isAI: true,
          explanation: "Yes! It learned your face.",
          minTrack: "explorers",
        },
        { scenario: "A crosswalk button", emoji: "🚶🔘", isAI: false, explanation: "No — press, wait, walk." },
      ],
    },
  },
  {
    ...
    config: {
      ...
      items: [
        ...
        { scenario: "A jump rope", emoji: "🪢", isAI: false, explanation: "No — just swings." },
        { scenario: "A board game die", emoji: "🎲", isAI: false, explanation: "No — random, not learned." },
        {
          scenario: "Finishes your rhythm when you clap",
          emoji: "👏🎶",
          isAI: true,
          explanation: "Yes! It learned the pattern.",
          minTrack: "explorers",
        },
        { scenario: "Makes a new picture from your words", emoji: "💬🖼️", isAI: true, explanation: "Yes! It learned from lots of pictures." },
      ],
    },
  },
  {
    ...
    config: {
      ...
      items: [
        ...
        { scenario: "A towel", emoji: "🧻", isAI: false, explanation: "No — just soaks up water." },
        { scenario: "A doorknob", emoji: "🚪🔘", isAI: false, explanation: "No — just turns." },
        {
          scenario: "Reads a menu in another language for you",
          emoji: "📋🌐",
          isAI: true,
          explanation: "Yes! It learned two languages.",
          minTrack: "explorers",
        },
        {
          scenario: "Dims the screen when you're falling asleep",
          emoji: "📱😴",
          isAI: true,
          explanation: "Yes! It watched and learned.",
          minTrack: "explorers",
        },
      ],
    },
  },
  {
    ...
    config: {
      ...
      items: [
        ...
        { scenario: "A flag", emoji: "🚩", isAI: false, explanation: "No — just waves." },
        { scenario: "A compass", emoji: "🧭", isAI: false, explanation: "No — always points the same way." },
        {
          scenario: "Warns about a coming earthquake pattern",
          emoji: "🌍⚠️",
          isAI: true,
          explanation: "Yes! It learned from past data.",
          minTrack: "explorers",
        },
        {
          scenario: "Picks the best route around traffic",
          emoji: "🚗🛣️",
          isAI: true,
          explanation: "Yes! It learned traffic patterns.",
          minTrack: "explorers",
        },
      ],
    },
