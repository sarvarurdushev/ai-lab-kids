import type { ActivityEngine, BigIdea } from "./types";
...
export const STANDARDS_ALIGNMENT: StandardsMapping[] = [
  {
    engine: "ai_or_not",
    activityLabel: "AI Lab · Is It AI?",
    standardLine:
      "Real-world AI recognition, matching ISTE's elementary recommendation to identify AI in daily life, and AI4K12 Big Idea 5 (Societal Impact).",
  },
  {
    engine: "instruct_vora",
    activityLabel: "AI Lab · Clear Instructions",
    standardLine:
      "Precise-instruction practice, matching the UNESCO AI Competency Framework's \"AI techniques and applications\" / \"AI system design\" dimensions.",
  },
  {
    engine: "train_the_robot",
    activityLabel: "Sorting Game (Train the Robot)",
    standardLine:
      "Kids label training examples, then test Vora on unseen ones and see why mistakes happen — CSTA 1B-DA-06, AI4K12 Big Ideas 1 & 3 (Perception, Learning).",
  },
  {
    engine: "pattern_predictor",
    activityLabel: "Pattern Game",
    standardLine: "Finding a rule in examples to predict what comes next — AI4K12 Big Idea 2 (Representation & Reasoning).",
  },
];
