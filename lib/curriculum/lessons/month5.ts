...
export const m5_week1: Lesson = {
  ...
  segments: [
    ...
    {
      type: "wrapup",
      summary: "Today we learned family words and the sentence \"This is my ___\" — and how even the smartest AI can mix up faces that you'd never confuse — practiced spotting real AI in everyday life, and helped Vora follow clear instructions.",
...
export const m5_week2: Lesson = {
  ...
  segments: [
    ...
    {
      type: "wrapup",
      summary: "Today we built the sentence \"This is my brother\" tile by tile, then practiced it with a second game — sorting family and school words — and helped Vora follow clear step-by-step instructions.",
    },
  ],
};
...
export const m5_week3: Lesson = {
  ...
  segments: [
    ...
    {
      type: "wrapup",
      summary: "Today we played three activities — sorting family words from school words, building the sentence \"This is my brother\" tile by tile, and spotting real AI in everyday life.",
    },
  ],
};
...
export const m5_week4: Lesson = {
  ...
  segments: [
    ...
    {
      type: "wrapup",
      summary: "Today every child proudly introduced one real family member in English — the whole point of the sentence — helped Vora follow clear instructions, and spotted real AI in everyday life.",
