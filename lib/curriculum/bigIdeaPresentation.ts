...
export const BIG_IDEA_PRESENTATION: Record<BigIdea, BigIdeaPresentation> = {
  perception: {
    ...
    kidLine: {
      en: "This is AI perception — how Robi notices and makes sense of what it sees or hears.",
      ko: "이건 AI의 '지각'이에요 — 로비가 보고 듣는 것을 알아차리고 이해하는 방법이에요.",
    },
  ...
  reasoning: {
    ...
    kidLine: {
      en: "This is AI reasoning — how Robi finds a pattern and figures out what comes next.",
      ko: "이건 AI의 '추론'이에요 — 로비가 패턴을 찾아 다음에 올 것을 알아내는 방법이에요.",
    },
  ...
  learning: {
    ...
    kidLine: {
      en: "This is AI learning — how Robi gets better by seeing lots of examples, and sometimes still guesses wrong.",
      ko: "이건 AI의 '학습'이에요 — 로비가 많은 예시를 보며 점점 더 잘하게 되고, 가끔은 틀리게 추측하기도 해요.",
    },
  ...
  natural_interaction: {
    ...
    kidLine: {
      en: "This is AI natural interaction — how Robi listens, waits its turn, and talks back like a friend.",
      ko: "이건 AI의 '자연스러운 상호작용'이에요 — 로비가 친구처럼 듣고, 차례를 기다리고, 대답하는 방법이에요.",
    },
