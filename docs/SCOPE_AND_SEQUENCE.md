...
| 3 | Colors & Patterns | 2 | Robi Finds the Pattern | Reasoning, Learning | Shape nouns, same/different |
...
| 7 | Robot Helpers | 3 | Robi Can, Robi Can't | Societal Impact, Learning | "can" / "can't" sentence building |
...
| 8 | Show What You Know | 3 | Teach Robi Day (capstone) | Learning, Societal Impact | Free production, category description |

## Reading this as a curriculum reviewer

- **Every lesson has:** a warmup with a verbatim teacher script (English +
  Korean), explicit vocabulary or a concept segment (Robi's lines, shown
...
- **Localization is substantive, not cosmetic.** Every line of every
  lesson — teacher scripts, vocabulary, Robi's dialogue, instructions,
